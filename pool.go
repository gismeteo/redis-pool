...
func newErrorStringIntMapCmd(err error) *redis.MapStringIntCmd {
...
func (p *Pool) Set(ctx context.Context, key string, value any, expiration time.Duration) *redis.StatusCmd {
...
func (p *Pool) SetNX(ctx context.Context, key string, value any, expiration time.Duration) *redis.BoolCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
...
func (p *Pool) SetXX(ctx context.Context, key string, value any, expiration time.Duration) *redis.BoolCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorBoolCmd(err)
	}
...
func (p *Pool) Echo(ctx context.Context, message any) *redis.StringCmd {
	conn, err := p.connFactory.getMasterConn()
	if err != nil {
		return newErrorStringCmd(err)
	}
...
func (p *Pool) MGetWithGD(ctx context.Context, keys ...string) ([]any, map[string]error) {
...
func (p *Pool) MGet(ctx context.Context, keys ...string) ([]any, error) {
...
func (p *Pool) MSetWithGD(ctx context.Context, values ...any) []*redis.StatusCmd {
	conn, _ := p.connFactory.getMasterConn()
...
func (p *Pool) MSet(ctx context.Context, values ...any) *redis.StatusCmd {
...
func (p *Pool) MSetNX(ctx context.Context, values ...any) *redis.BoolCmd {
	conn, err := p.connFactory.getMasterConn()
	if err != nil {
		return newErrorBoolCmd(err)
	}
...
func (p *Pool) Eval(ctx context.Context, script string, keys []string, args ...any) *redis.Cmd {
	conn, err := p.connFactory.getMasterConn()
	if err != nil {
		return newErrorCmd(err)
	}
...
func (p *Pool) EvalSha(ctx context.Context, sha1 string, keys []string, args ...any) *redis.Cmd {
	conn, err := p.connFactory.getMasterConn()
	if err != nil {
		return newErrorCmd(err)
	}
...
func (p *Pool) ScriptExists(ctx context.Context, hashes ...string) *redis.BoolSliceCmd {
	conn, err := p.connFactory.getMasterConn()
	if err != nil {
		return newErrorBoolSliceCmd(err)
	}
...
func (p *Pool) Publish(ctx context.Context, channel string, message any) *redis.IntCmd {
	conn, err := p.connFactory.getMasterConn()
	if err != nil {
		return newErrorIntCmd(err)
	}
...
func (p *Pool) BitField(ctx context.Context, key string, args ...any) *redis.IntSliceCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
...
func (p *Pool) HMSet(ctx context.Context, key string, values ...any) *redis.BoolCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorBoolCmd(err)
	}
...
func (p *Pool) HSetNX(ctx context.Context, key, field string, value any) *redis.BoolCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorBoolCmd(err)
	}
...
func (p *Pool) LInsert(ctx context.Context, key, op string, pivot, value any) *redis.IntCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorIntCmd(err)
	}
...
func (p *Pool) LInsertBefore(ctx context.Context, key string, pivot, value any) *redis.IntCmd {
	return p.LInsert(ctx, key, "BEFORE", pivot, value)
}

func (p *Pool) LInsertAfter(ctx context.Context, key string, pivot, value any) *redis.IntCmd {
...
func (p *Pool) LPush(ctx context.Context, key string, values ...any) *redis.IntCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorIntCmd(err)
	}
...
func (p *Pool) LPushX(ctx context.Context, key string, values ...any) *redis.IntCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorIntCmd(err)
	}
...
func (p *Pool) LRem(ctx context.Context, key string, count int64, value any) *redis.IntCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorIntCmd(err)
	}
...
func (p *Pool) LSet(ctx context.Context, key string, index int64, value any) *redis.StatusCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorStatusCmd(err)
	}
...
func (p *Pool) RPush(ctx context.Context, key string, values ...any) *redis.IntCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorIntCmd(err)
	}
...
func (p *Pool) RPushX(ctx context.Context, key string, values ...any) *redis.IntCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorIntCmd(err)
	}
...
func (p *Pool) SAdd(ctx context.Context, key string, members ...any) *redis.IntCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorIntCmd(err)
	}
...
func (p *Pool) SIsMember(ctx context.Context, key string, member any) *redis.BoolCmd {
	conn, err := p.connFactory.getSlaveConn(key)
	if err != nil {
		return newErrorBoolCmd(err)
	}
...
func (p *Pool) SMove(ctx context.Context, source, destination string, member any) *redis.BoolCmd {
	conn, err := p.connFactory.getMasterConn()
	if err != nil {
		return newErrorBoolCmd(err)
	}
...
func (p *Pool) SRem(ctx context.Context, key string, members ...any) *redis.IntCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorIntCmd(err)
	}
...
func (p *Pool) ZRem(ctx context.Context, key string, members ...any) *redis.IntCmd {
	conn, err := p.connFactory.getMasterConn(key)
	if err != nil {
		return newErrorIntCmd(err)
	}
...
func (p *Pool) PFAdd(ctx context.Context, key string, els ...any) *redis.IntCmd {
	conn, err := p.connFactory.getMasterConn()
	if err != nil {
		return newErrorIntCmd(err)
	}
